...
def prompt_completion_chat(question="", model="gpt-3.5-turbo", n=1, temperature=0.0, max_tokens=256, system_description="You write content for Magic the Gathering. You love the game and have a firm grasp of its mechanics. You also good world building as much as you love good gameplay.", messages=None):
    start_time = time.perf_counter()
    prompt = f"{question} "
